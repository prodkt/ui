...
<Preview shadcn name="accordion" code={`
import {
  Accordion,
  AccordionContent,
  AccordionItem,
  AccordionTrigger,
} from "@/components/ui/prodkt-ui/accordion"

export function AccordionDemo() {
  return (
    <div className="grid w-full max-w-full gap-4 p-8">
...
<Installer packageName="accordion" />
...
The `AccordionItemProps` component is used to display the accordion.

<AutoTypeTable path="../../packages/shadcn-ui/node_modules/@radix-ui/react-accordion/dist/index.d.ts" name="AccordionItemProps" />


### AccordionContent

The `AccordionContentProps` component is used to display the accordion content.

<AutoTypeTable path="../../packages/shadcn-ui/node_modules/@radix-ui/react-accordion/dist/index.d.ts" name="AccordionContentProps" />


### AccordionTrigger

The `AccordionTriggerProps` component is used to display the accordion trigger.

<AutoTypeTable path="../../packages/shadcn-ui/node_modules/@radix-ui/react-accordion/dist/index.d.ts" name="AccordionTriggerProps" />
