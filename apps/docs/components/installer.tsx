...
import prodkt from '../public/logomark.svg';
...
export const Installer = ({ packageName }: InstallerProps) => {
  const [value, setValue] = useState('prodkt-ui');

  const commands = {
    'prodkt-ui': {
      image: prodkt,
      code: `npx prodkt-ui@latest add ${packageName}`,
    },
    shadcn: {
      image: shadcn,
      code: `npx shadcn@latest add https://www.prodkt.cloud/registry/${packageName}.json`,
    },
  };
