...
export const Swatch = ({ scale, step, style, ...props }: SwatchProps) => {
  ...
  return (
    <Dialog>
      <DialogTrigger
        className={cn(styles.SwatchTrigger, styles.SwatchTransparencyGrid)}
        {...props}
      >
      ...
      >
        <DialogTitle>{friendlyColorName}</DialogTitle>
            ...
            (() => {
              ...
              return (
                <div className="grid grid-cols-3">
                  ...
                  <p className="col-span-1">Pairs with</p>
                  <div className="col-span-2">
                    <p>
                  ...
                  <Separator className="col-span-3 h-px w-full bg-border" />

                  <p className="col-span-1">Solid color</p>

                  <div className="col-span-2">
                    <CopyButton>{hex}</CopyButton>
                  </div>

                  <div className="col-span-1 inline-flex items-center justify-start">
                    <p>Alpha color</p>
                    <Popover modal>
                      <PopoverTrigger>
                      ...
                      >
                        ...
                        <Text as="p" size="2" trim="both" mb="4">
                          ...
                          same look against a neutral background. Alpha colors
                          are used for elements that need to retain contrast
                          when overlayed over different backgrounds
                        </Text>
                  ...
                  <p className="col-span-1">P3 color</p>
                  <div className="col-span-2">
                    <CopyButton>{p3}</CopyButton>
                  </div>

                  <p className="col-span-1">P3 alpha</p>
                  <div className="col-span-2">
                  ...
                  {+step <= 5 && (
                    <>
                      ...
                      <p className="col-span-1">Step 11 contrast</p>
                      <p className="col-span-2">
                        Lc {stepContrastInfo.step11.toFixed(1)}
                      </p>

                      <p className="col-span-1">Step 12 contrast</p>
                      <p className="col-span-2">
                  ...
                  {+step >= 11 && (
                    <>
                      ...
                      <p className="col-span-1">Step 1 contrast</p>
                      <p className="col-span-2">
                        Lc {stepContrastInfo.step1.toFixed(1)}
                      </p>

                      <p className="col-span-1">Step 2 contrast</p>
                      <p className="col-span-2">
                        Lc {stepContrastInfo.step2.toFixed(1)}
                      </p>

                      <p className="col-span-1">Step 3 contrast</p>
                      <p className="col-span-2">
                        Lc {stepContrastInfo.step3.toFixed(1)}
                      </p>

                      <p className="col-span-1">Step 4 contrast</p>
                      <p className="col-span-2">
                        Lc {stepContrastInfo.step4.toFixed(1)}
                      </p>

                      <p className="col-span-1">Step 5 contrast</p>
                      <p className="col-span-2">
...
interface CopyButtonState {
  open: boolean;
  text: 'Click to copy' | 'Copied' | 'Failed to copy';
