...
export const GanttHeader: FC<GanttHeaderProps> = ({ className }) => {
  ...
  return (
    <div
      className={cn(
        '-gap-x-px flex h-full w-max divide-x divide-border/50',
        className
      )}
    >
      <Header />
...
export const GanttFeatureDragHelper: FC<GanttFeatureDragHelperProps> = ({
  ...
  return (
    ...
    >
      <div
        className={cn(
          '-translate-y-1/2 absolute top-1/2 h-[80%] w-1 rounded-xs bg-muted-foreground opacity-0 transition-all',
          direction === 'left' ? 'left-2.5' : 'right-2.5',
...
export const GanttFeatureList: FC<GanttFeatureListProps> = ({
  ...
  <div
    className={cn('absolute top-0 left-0 h-full w-max gap-y-4', className)}
...
export const GanttProvider: FC<GanttProviderProps> = ({
  ...
  return (
    ...
    >
      <div
        className={cn(
          'gantt relative grid h-full w-full flex-none select-none overflow-auto rounded-xs bg-secondary',
          range,
          className
        )}
        style={{
