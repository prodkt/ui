...
export const StorybookLogomark = (props: SVGProps<SVGSVGElement>) => (
  <svg
    width={256}
    height={319}
    viewBox="0 0 256 319"
  ...
  >
    ...
    <defs>
      <path
        ...
        id="a-storybookLogomark"
      />
    </defs>
    <mask id="b" fill="currentColor">
      <use xlinkHref="#a-storybookLogomark" />
    </mask>
    <use fill="var(--pink-9)" xlinkHref="#a-storybookLogomark" />
    <path
