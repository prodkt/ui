...
export const NodejsLogomark = (props: SVGProps<SVGSVGElement>) => (
  <svg
    width={256}
    height={292}
    viewBox="0 0 256 292"
  ...
  >
    ...
    <path
      d="M134.923 1.832c-4.344-2.443-9.502-2.443-13.846 0L6.787 67.801C2.443 70.244 0 74.859 0 79.745v132.208c0 4.887 2.715 9.502 6.787 11.945l114.29 65.968c4.344 2.444 9.502 2.444 13.846 0l114.29-65.968c4.344-2.443 6.787-7.058 6.787-11.945V79.745c0-4.886-2.715-9.501-6.787-11.944L134.923 1.832Z"
      fill="url(#nodejs-linearGradient-1)"
    />
    <mask id="nodejs-mask-3" fill="#fff">
      <use xlinkHref="#nodejs-path-2" />
    </mask>
    <path
      ...
      fill="url(#nodejs-linearGradient-4)"
      mask="url(#nodejs-mask-3)"
    />
    <mask id="nodejs-mask-6" fill="#fff">
      <use xlinkHref="#nodejs-path-5" />
    </mask>
    <path
      ...
      fill="url(#nodejs-linearGradient-7)"
      mask="url(#nodejs-mask-6)"
    />
  </svg>
)
