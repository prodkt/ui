...
export const SandboxTabs = ({
  ...
  return (
    <SandboxTabsContext.Provider value={{ selectedTab, setSelectedTab }}>
      <div
        className={cn(
          'group relative flex size-full flex-col overflow-hidden rounded-xl border text-sm',
          className
        )}
        {...props}
...
export const SandboxTabsList = ({
  ...
  <div
    className={cn(
      'inline-flex gap-x-1 w-full shrink-0 items-center justify-start border-b bg-secondary p-2 text-muted-foreground',
      className
    )}
    role="tablist"
    {...props}
...
export const SandboxTabsTrigger = ({
  ...
  return (
    ...
    <button
      ...
      className={cn(
        'inline-flex items-center justify-center gap-1.5 whitespace-nowrap rounded-md px-3 py-1 text-sm ring-offset-background transition-all focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:bg-background data-[state=active]:text-foreground data-[state=active]:shadow-sm',
        className
      )}
      {...props}
    />
...
export const SandboxTabsContent = ({
  ...
  return (
    <div
      ...
      data-state={selectedTab === value ? 'active' : 'inactive'}
      className={cn(
        'flex-1 overflow-y-auto ring-offset-background transition-opacity duration-200 focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2',
        selectedTab === value
