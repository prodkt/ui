  ...
  return (
    <button
      ...
      className={cn(
        ...
        'ring-offset-background transition-colors focus-visible:outline-hidden focus-visible:ring-2',
...
export const DialogStackContent = ({
  ...
  return (
    ...
    <div
      onClick={handleClick}
      className={cn(
        'h-auto w-full rounded-lg border bg-background p-6 shadow-xl transition-all duration-300',
...
export const DialogStackFooter = ({
  ...
  <div
    className={cn('flex items-center justify-end gap-x-2 pt-4', className)}
    {...props}
  >
    {children}
  </div>
