...
export const ColorPickerHue = ({
  ...
  return (
    ...
    >
      ...
      <Thumb className="block h-4 w-4 rounded-full border border-primary/50 bg-background shadow-xs transition-colors focus-visible:outline-hidden focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50" />
    </Root>
  );
};
...
export const ColorPickerFormat = ({
  ...
  if (mode === 'hex') {
    ...
    return (
      <div
        className={cn(
          '-gap-x-px relative flex items-center shadow-xs',
          className
        )}
        {...props}
      >
  ...
  if (mode === 'rgb') {
    ...
    return (
      <div
        className={cn('-gap-x-px flex items-center shadow-xs', className)}
        {...props}
      >
        {rgb.map((value, index) => (
          <Input
